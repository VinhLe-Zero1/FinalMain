...
namespace capnhap
{
    class NewInfosController
    {
        ...
        {
            System.Data.SqlClient.SqlConnection connection = new SqlConnection("Data Source=DESKTOP-RHERCMS\\SQLEXPRESS;Initial Catalog=OneForAll;Integrated Security=True");
            connection.Open();
